...
### Дополнительные задания в соответствии с условиями
В процессе выполнения ДЗ выполнены дополнительные задания, а именно:  
1. Дополнительное задание №1: Реализовать формирование отчетов Allure.
2. Дополнительное задание №2: Реализовать параллельный запуск тестов.
3. Дополнительное задание №3: Реализовать запуск в системе CI/CD.  
### Некоторые подробности по CI/CD и Allure
